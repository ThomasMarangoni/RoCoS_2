...
def setupMainValidators(mainUi):
    ...
    mainUi.lineEdit_channel_cw_percent.setValidator(integerValidator)
    mainUi.lineEdit_channel_mw_seconds.setValidator(doubleValidator)
    mainUi.lineEdit_channel_mw_percent.setValidator(integerValidator)
    mainUi.lineEdit_channel_mu_percent.setValidator(integerValidator)
    ...
    mainUi.lineEdit_receiver_filter_rake_receiver_percent.setValidator(integerValidator)
